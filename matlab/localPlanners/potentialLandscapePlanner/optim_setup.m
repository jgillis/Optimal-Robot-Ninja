...
if strcmp(solver_str,'ipopt')==1
    ...
    opts.qpsol = 'nlpsol';
    if strcmp(solver_str,'sqp1')==1
    	opts.max_iter = 1;
    elseif strcmp(solver_str,'sqp2')==1
    	opts.max_iter = 2;
    end
...
elseif strcmp(solver_str,'sqp1')==1
    if with_end
        problemSqp1B = problem;
        save 'problemSqp1B.mat' 'problemSqp1B'
    else
        problemSqp1A = problem;
        save 'problemSqp1A.mat' 'problemSqp1A'
    end
elseif strcmp(solver_str,'sqp2')==1
    if with_end
        problemSqp2B = problem;
        save 'problemSqp2B.mat' 'problemSqp2B'
    else
        problemSqp2A = problem;
        save 'problemSqp2A.mat' 'problemSqp2A'
    end
else
    if with_end
        problemSqpAllB = problem;
        save 'problemSqpAllB.mat' 'problemSqpAllB'
    else
        problemSqpAllA = problem;
        save 'problemSqpAllA.mat' 'problemSqpAllA'
    end
end
